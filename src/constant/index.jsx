import { bigShoe1, thumbnailShoe1, bigShoe2, thumbnailShoe2, bigShoe3, thumbnailShoe3 } from "@/assets/images";
...
export const statistics = [
  { value: '1k+', label: 'Students Tutored' },
  { value: '500+', label: 'Tutors Available' },
  { value: '250+', label: 'Subjects Offered' },
];
...
export const featuresData = [
    {
      id: 1,
      icon: (
        <svg width="40" height="41" viewBox="0 0 40 41" className="fill-current" fill="white">
        <path
          opacity="0.5"
      ...
      title: "E Wallets",
      paragraph:
        "E wallets is a popular payment option which enables online purchases without having to enter payment details of each transaction it is very user friendly and secure it supports many topup methods and thus enables you to reach the unbanked too.",
    },
    {
      id: 2,
      icon: (
        <svg width="40" height="40" viewBox="0 0 40 40" className="fill-current" fill="white">
        <path
          opacity="0.5"
      ...
      title: "Vouchers",
      paragraph:
"Digital vouchers continue to snowball due to increased customer demand for convince The ease of their distribution and activation stimulate trials and conversion "    },

    {
      ...
      paragraph:
"Your customers can pay in any currency with the majoe debit and credit cards"
    }
];
